...
CFLAG = -I../ -I./minisat -D__STDC_LIMIT_MACROS -D __STDC_FORMAT_MACROS -c -g -fpermissive -O3 -lpthread
#CFLAG = -I../ -I./glucose -D__STDC_LIMIT_MACROS -D __STDC_FORMAT_MACROS -c -g -fpermissive -O3

LFLAG = -g -lz -lpthread
#segmentation debug -fsanitize=address
GCC = gcc
